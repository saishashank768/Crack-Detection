...
file = st.file_uploader("Please upload a crack image", type=["jpg", "png"])
...
if file is None:
    ...
    class_names = ['diagonal', 'horizontal', 'structural', 'vertical']
    result = f"This image most likely is: {class_names[np.argmax(predictions)]}"
    st.success(result)
